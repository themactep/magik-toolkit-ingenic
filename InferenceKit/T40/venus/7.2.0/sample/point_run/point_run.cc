...
//#define MEMORY_MODEL
#ifdef MEMORY_MODEL
#include "magik_model_t40_graph_point.mk.h"
#endif
#include "point80x80.h"
#include "venus.h"
#include <errno.h>
#include <fstream>
#include <iostream>
...
int main(int argc, char **argv) {
    ...
    std::string model_path = "./t40_graph_point.bin";
    std::unique_ptr<venus::BaseNet> test_net = venus::net_create();
#ifdef MEMORY_MODEL
    {
        MagikModelT40GraphPointMk model;
    ...
    printf("out_ptr=%p\n", out_ptr);
    std::string out_name = "point_out.bin";
    std::ofstream owput;
