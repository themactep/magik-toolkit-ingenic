...
from vision_quantize.ssd.mb_tiny_RFB_fd import create_Mb_Tiny_RFB_fd, create_Mb_Tiny_RFB_fd_predictor
import numpy as np
...
val_image_root = "/home/xjyu/sfyan/Ultra-Light-Fast-Generic-Face-Detector-1MB-RGB/data/WIDER_val/images"  # path to widerface valuation image root
val_result_txt_save_root = "./widerface_evaluation/"  # result directory

if net_type == 'slim':
    #model_path = "../models/pretrained/version-slim-320.pth"
    # model_path = "../models/pretrained/version-slim-640.pth" 
    model_path = "../models/sfyan_4bit_1127_clip2.0/slim-Epoch-202-Loss-3.006300452903465.pth"
