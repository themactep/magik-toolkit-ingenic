...
//    check_pixel_offset(pixel_offset);
    ...
    magik::venus::common_resize_nv12((const void*)tensor_data, *input.get(), ori_img_h, ori_img_w, line_stride, cvtbgra, magik::venus::PaddingType::SYMMETRY, 0, magik::venus::AddressLocate::NMEM_VIRTUAL);
